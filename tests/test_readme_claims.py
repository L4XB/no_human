...
CITATION_TABLE = (
    ...
    ("security.md", "cli/commands.py:merge_stack_run:3185", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5443", "cli/commands.py",
     '_refuse_agent_gate_act("approve")'),
    ("security.md", ":merge_stack_run:3155", "cli/commands.py",
